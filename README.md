...
1. Download the workshop [ZIP file](https://github.com/yoavram/DataSciPy/archive/refs/heads/amat2025b.zip).
1. Unzip the ZIP; make note of the unzipped folder location.
1. If using *VS Code* (requires additional install from [here](https://code.visualstudio.com/download)):
 - Open VS Code and open the workshop folder.
1. If using *Jupyter Lab*:
 - Change folder to the workshop folder (`cd <unzipped workshop folder>`)
